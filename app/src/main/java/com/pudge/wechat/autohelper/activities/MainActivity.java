package com.pudge.wechat.autohelper.activities;
...
import com.pudge.wechat.autohelper.R;
import com.pudge.wechat.autohelper.utils.ConnectivityUtil;
import com.pudge.wechat.autohelper.utils.UpdateTask;
...
public class MainActivity extends Activity implements AccessibilityManager.AccessibilityStateChangeListener {
    ...
    /**
     * 更新当前 WechatAutoHelperService 显示状态
     */
    ...
    /**
     * 获取 WechatAutoHelperService 是否启用状态
     *
     * @return
     */
    private boolean isServiceEnabled() {
        ...
        for (AccessibilityServiceInfo info : accessibilityServices) {
            if (info.getId().equals(getPackageName() + "/.services.WechatAutoHelperService")) {
